...
<body>
    ...
    <tr class="netincome">
        <td>手取給与</td>
        <td class="net-income"><?= number_format($salaryForPL[0]->netIncome); ?></td>
    </tr>
    @endif
    ...
    @if (!empty($costsForPL) === true)
        ...
        <tr class="balance">
            <td>差引貯蓄可能額</td>
            <td><?= number_format($salaryForPL[0]->netIncome - $cost); ?></td>
        </tr>
    @endif
    ...
    <tr>
        <td>総労働時間</td>
        <td>{{ $hoursForPL[0]->fixedTime + $hoursForPL[0]->overTime }}</td>
    </tr>
    <tr>
        <td>定時間</td>
        <td>{{ $hoursForPL[0]->fixedTime }}</td>
    </tr>
    <tr>
        <td>残業時間</td>
        <td>{{ $hoursForPL[0]->overTime }}</td>
    </tr>
    <tr>
        <td>時間当たり手取り</td>
        <td><?= round(($salaryForPL[0]->netIncome / ($hoursForPL[0]->fixedTime + $hoursForPL[0]->overTime)), 2); ?></td>
    </tr>
    @endif
