...
class SelectYearMonthController extends Controller
{
    ...
    public function yearMonthSelectorForTopTen()
    {
        ...
        return view('selectYearMonth.selectYearMonth', [
            'yearSelectors' => $yearSelectors, 'monthSelectors' => $monthSelectors, 'title' => '経費計上金額トップ10を見る', 'h2' => '経費計上金額トップ10を見る',
    ...
    public function yearMonthSelectorForPl()
    {
        ...
        return view('selectYearMonth.selectYearMonth', [
            'yearSelectors' => $yearSelectors, 'monthSelectors' => $monthSelectors, 'title' => '個人PLの参照(単月)', 'h2' => '年月を選択してPLを出力しよう！',
    ...
    public function yearMonthSelectorForPls()
    {
        ...
        $monthSelectors = Salary::groupBy('month')->get('month');
        return view('selectYearMonth.selectYearMonth', [
            'yearSelectors' => $yearSelectors, 'monthSelectors' => $monthSelectors, 'title' => '個人PLの参照(複数月)', 'h2' => '年月を選択してPLを出力しよう！',
            'action' => '/outputpl/referencepls', 'inputVal' => '指定した年月から過去2ヶ月分のPL出力'
        ]);
    }

    // PL出力四半期 model 
    public function yearMonthSelectorForQuarterPl()
    {
        $yearSelectors = Salary::groupBy('year')->get('year');
        return view('selectYearMonth.selectYearMonth', [
            'yearSelectors' => $yearSelectors, 'title' => '個人PLの参照(四半期)', 'h2' => '年月を選択してPLを出力しよう！',
            'action' => '/outputpl/referencequarterpl', 'inputVal' => '指定した年月から過去四半期分のPL出力'
        ]);
    }
    ...
    public function yearMonthSelectorForPieChart()
    {
        ...
        $monthSelectors = Cost::groupBy('month')->get('month');
        return view('selectYearMonth.selectYearMonth', [
            'yearSelectors' => $yearSelectors, 'monthSelectors' => $monthSelectors, 'title' => '経費計上円グラフの出力', 'h2' => '経費計上円グラフの出力',
    ...
    public function yearMonthSelectorForLineGraphDaily()
    {
        ...
        $monthSelectors = Cost::groupBy('month')->get('month');
        return view('selectYearMonth.selectYearMonth', [
            'yearSelectors' => $yearSelectors, 'monthSelectors' => $monthSelectors, 'title' => '経費計上折れ線グラフの出力(単月)', 'h2' => '経費計上折れ線グラフの出力(単月)',
    ...
    public function yearMonthSelectorForLineGraphsDaily()
    {
        ...
        $monthSelectors = Cost::groupBy('month')->get('month');
        return view('selectYearMonth.selectYearMonth', [
            'yearSelectors' => $yearSelectors, 'monthSelectors' => $monthSelectors, 'title' => '経費計上折れ線グラフの出力(複数月)', 'h2' => '経費計上折れ線グラフの出力(複数月)',
    ...
    public function yearMonthSelectorforCalender()
    {
        ...
        $monthSelectors = Cost::groupBy('month')->get('month');
        return view('selectYearMonth.selectYearMonth', [
            'yearSelectors' => $yearSelectors, 'monthSelectors' => $monthSelectors, 'title' => '経費計上カレンダーの出力', 'h2' => '経費計上カレンダーの出力',
    ...
    public function yearMonthSelectorForLineGraphDailyAmount()
    {
        ...
        $monthSelectors = Cost::groupBy('month')->get('month');
        return view('selectYearMonth.selectYearMonth', [
            'yearSelectors' => $yearSelectors, 'monthSelectors' => $monthSelectors, 'title' => '日別の経費計上合計額推移の参照(単月)', 'h2' => '日別の経費計上合計額を参照する(単月)',
    ...
    public function yearMonthSelectorForLineGraphDailyAmounts()
    {
        ...
        $monthSelectors = Cost::groupBy('month')->get('month');
        return view('selectYearMonth.selectYearMonth', [
            'yearSelectors' => $yearSelectors, 'monthSelectors' => $monthSelectors, 'title' => '日別の経費計上合計額推移の参照(複数月)', 'h2' => '日別の経費計上合計額を参照する(複数月)',
